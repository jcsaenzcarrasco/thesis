...
xrange = range(2850:3010)  # (300:460), (1500:1660)
yrange = range(1300:1800)  # (570:820) , (80:170)  (730:840)   , (1600:1800)
...
lines( t1K_300$n,t1K_300$each1e6   
     , type = "o"      # line type 
     , col  = "blue4"  
     , pch  = 8        # line character 
     , lty  = 1        # line pattern 
     , lwd  = 1)       # line width 
lines( t500_300$n,t500_300$each1e6      
     , type = "o"      # line type 
     , col  = "darkgreen"  
