...
t1K  <- read.csv("benTop-linkCutsT300-1K-100points.csv")
t500 <- read.csv("benTop-linkCutsT300-500-100points.csv")
t300 <- read.csv("benTop-linkCutsT300-300-100points.csv")
...
title(xlab="number of nodes (sampling every 100 medians)", line=2.5, cex.lab=1.2)
